...
<div class="text-start">
  ...
  <div class="rowt rowt-colts-1 rowt-colts-sm-1 rowt-colts-md-1">
    ...
    <span class="eedtbt edit-account-p2p" data-index="<?php echo esc_attr($index); ?>" data-bs-toggle="modal" data-bs-target="#editAccountModal">Edit</span> | 
...
?>
  ...
  <div class="rowt">
    <div class="colt-6 text-start mtttp"><span class="xcsse" id="staticBackdropLabel" style="padding-left:20px;">Add P2P Account</span></div>
